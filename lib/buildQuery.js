...
var allPoliticians = 'select top 1000 X1.ct_recno, X1.ct_recno as recno, X1.ct_searchname as name, X3.to_no as phone, X1.ct_title as title, X4.to_no as privateMail, X6.to_no as mobilePhone, X14.ad_zip as zip, X14.ad_address as address, X15.scv_code as gender, X18.ct_recno, X21.co_desc, X24.to_no as publicMail' +
...
var politicianCommittees = 'select X1.ctct_recno as groupRecno, X2.ct_recno as recno, X2.ct_searchname as name, X4.ccr_roleto as role, X4.ccr_desc as roleDesription' +
  ...
  ' where ((X2.ct_active  =  -1 and X4.ccr_displaymain  =  -1 '
