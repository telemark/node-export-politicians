...
var politicianCommittees = 'select X1.ctct_from as recno, X2.ct_recno as groupRecno, X2.ct_searchname as name, X4.ccr_roleto as role, X4.ccr_desc as roleDesription, X9.ad_address as address, X9.ad_zipplace as place, ad_zip_code as zip, X10.to_no as mail, X11.to_no as tlf, X12.to_no as url' +
  ...
  ' where ((X2.ct_active  =  -1 and X4.ccr_displaymain  =  -1  and X1.ctct_from  = @PARAM ))'
